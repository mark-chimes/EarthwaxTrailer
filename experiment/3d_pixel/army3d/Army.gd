...
var ArmyGrid = preload("res://experiment/3d_pixel/army3d/ArmyGrid.gd")

# var creature = preload("res://desert_strike/creature/creature.tscn")
var Creature
onready var engine = get_parent().get_parent().get_node("Engine3D")
...
func create_and_add_creature(creatures_arr, CreatureType): 
	...
	engine.add_object_to_parallax_world(creature)	
...
func _on_creature_fire_projectile(archer_pos, target_band, target_lane, projectile): 
	...
	engine.add_object_to_parallax_world(projectile)
